    ...
    <div class="conteudo">
      ...
      <section className="section-impacto">
        ...
        <div className="impacto">
          <div className="imp1">
            <h1>
              <div className="value" contador-impacto="670">0</div>
            </h1>
            <h3>Doações<br /> recebidas</h3>
          </div>
          <div className="imp2">
            <h1>
              <div className="value" contador-impacto="1500">0</div>
            </h1>
            <h3>Dinheiro<br /> arrecadado</h3>
          </div>
          <div className="imp3">
            <h1>
              <div className="value" contador-impacto="11">0</div>
            </h1>
            <h3>ONGs<br /> parceiras</h3>
          </div>
          <div className="imp4">
            <h1>
              <div className="value" contador-impacto="500">0</div>
            </h1>
